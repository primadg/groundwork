...
class CI_Smarty extends Smarty
{
    ...
    {        
        ...
        $sClassName = 'controllers/' . $sClassName . '/' . $sViewName;
        ...
        if ($bFilePresent && MY_Controller::isAjaxRequest())
        {
            echo $sContent;
            die;
        } else
        ...
        $this->sysassign('aErrors', $this->oInstance->errors->get());
        $this->sysassign('aUserInfo', (array) $this->oInstance->session->userdata('user_info'));
