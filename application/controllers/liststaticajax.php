...
/**
* Liststaticajax Controller class
* @date: 11-June-2012
* @Purpose: This controller handles all the List static ajax functionalities.
* @filesource: application/controllers/lists.php
* @author:  Vyacheslav Isaev
* @version: 0.0.2 
* @revision: 
**/
class Liststaticajax extends MY_Controller {
    ...
    * @date: 11-June-2012
    * @Purpose: Index Page
    * @filesource: application/controllers/liststaticajax.php
    * @Param: 
    * @Return: 
    * @author: Vyacheslav Isaev
    * @version: 0.0.1
    ...
    */
    public function deletesomefields()
    {
        ...
        if(isset($lSortBy)&&!empty($lSortBy)&&isset($lFieldName)&&!empty($lFieldName))
        {
            ...
            // Удаляем данные в БД
            $affectedRows = $this->lists_model->deleteSomeFields($lSomeArray);
